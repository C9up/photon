 ...
 *
 * Loaded from the package barrel, so importing Photon anywhere in the
...
import type { PhotonRenderer } from "./PhotonRenderer.js";

declare module "@c9up/ream/types" {
	interface ContainerBindings {
		/** The React renderer, bound by `PhotonProvider`. */
		photon: PhotonRenderer;
	}
}
